    ...
    private class ConnectedThread extends Thread {
            ...
            while (!mUserCancel) {
                try {
                    ...
                    if(mConnectionListener != null && bytes > 0) {
                        ...
                        //Log.d("123","run  receive  "+new String(data)+"   length: "+data.length);
                        Log.d("123","run  receive  图片数据太长不显示了"+"   length: "+data.length);
        ...
        public void sendData(byte[] data) {
            try {
               ...
               // Log.d("123","sendData:  "+new String(data)+"   length: "+data.length);
                Log.d("123","sendData:  "+"图片数据太长不显示了"+"   length: "+data.length);
                if(mConnectionListener != null) {
